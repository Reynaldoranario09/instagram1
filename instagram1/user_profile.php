...
<body>  
    <div class="row">
     ...
     <div class="col-sm-12  ">
        ...
        <?php 
            if(isset($_GET['u_id'])){
                ...
                echo"
                    <div class='row'>
                       <div class='col-sm-1'>
                        ...
                        <center>
                        <div style='background-color:grey;  border-radius: 10%; float:inherit; padding:inherit;height:550px; width:700px; ' class='col-sm-3'>
                        <h2 style='color:white;'> ABOUT</h2>
                        <img class='img-rounded' src='users/$image' width='150'
                        height='150'>
                        <br><br>
                        <ul class='list-group'>
                        <li class='list-group-item' title='User Status'><strong style='color:black;'>$describe_user
                        </strong></li>  
                ...
                if($user_id == $userown_id) {
                    ...
                    class='btn btn-success'/>Edit Profile</a><br><br><br>";
                }
        ...
        ?>
        <div class="col-sm-6">
            <center><h1><strong><?php echo "$f_name $l_name"; ?><br></strong>Posts</h1></center>
                    ...
                    if($content=="No" && strlen($upload_image) >= 1){
                        echo "
                            <div id='own_posts'>
                                <div class='row'>
                                    <div class='col-sm-2'>
                                        <p><img src='users/$user_image' class='
                                        img-circle' width='100px' height='100px'</p>
                                    </div>
                                    <div class='col-sm-6'>
                                        <h3><a style='cursor:pointer; color:#3897f0;' href='
                                ...
                                <a href='single.php?post_id=$post_id' style='float:
                                right;'><button class='btn btn-success'>View</button></a>
                                <a href='functions/delete_post.php?post_id=$post_id' style='float:
                                right;'><button class='btn btn-danger'>Delete</button></a>
                            </div><br/><br/>
