...
$con = mysqli_connect("localhost", "root","","rey");

//function sa pag insert sa post
    ...
    if(isset($_POST['sub'])){
        ...
        if(strlen($content) > 250){
            ...
            if(strlen($upload_image) >= 1 && strlen($content) >= 1){
                ...
                $insert = "insert into posts (user_id, post_content, upload_image,post_date) values 
                ('$user_id', '$content', '$upload_image.$random_number', NOW())";
                ...
                if($upload_image='' && $content == ''){
                    ...
                    if($content== ''){
                        move_uploaded_file($image_tmp, "imagepost/$upload_image.$random_number");
                        $insert = "insert into posts (user_id, post_content, upload_image,post_date) values 
                        ('$user_id', 'No', '$upload_image.$random_number', NOW())";
                   ...
                   exit();
                        ...
                        $insert = "insert into posts (user_id, post_content,post_date) values 
                        ('$user_id', '$content', NOW())";
                        $run = mysqli_query($con, $insert);
        ...
        function get_posts(){
            ...
            //members function hyssst kapoy na oyyy
