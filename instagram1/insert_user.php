...
include ("includes/connection.php");
    ...
    if(isset($_POST['sign_up'])){
        ...
        $rub_username = mysqli_query($con,$check_username_query);
        ...
        if($rand == 1)
        $profile_pic = "head 1.png";
      else  if($rand == 2)
        $profile_pic = "head 2.png";
        else  if($rand == 3)
        ...
        values ('$first_name','$last_name','$username','Hello. This is my
        default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','cover.png',NOW(), '$status','$posts','Iwanttoputadingintheuniverse.')";
